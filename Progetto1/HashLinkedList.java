...
public class HashLinkedList<T> implements Iterable<T> {
    ...
    public void addAtHead(T data) {
        ...
        this.head = nuovoNodo;
        // Se la lista � vuota, aggiorno la coda
    ...
    public void addAtTail(T data) {
        ...
        this.tail = nuovoNodo;
        // Se la lista � vuota, aggiorno anche la testa
    ...
    public ArrayList<String> getAllHashes() {
        ...
        while(iterator.hasNext()) {
            ...
            // Ciclo finch� il nodo corrente non � nullo
            while(corrente != null) {
     ...
     * @return true se l'elemento � stato trovato e rimosso, false altrimenti.
     */
	public boolean remove(T data) {
	        ...
	        if(dataCorrente.equals(data)) {
	            ...
	            while(corrente != null) {
	                ...
	                if(corrente.data.equals(data)) {
	                    ...
	                    // Aumento il contatore delle modifiche
	                    this.numeroModifiche++;
	                    // Ritorno true per indicare che l'elemento � stato rimosso
	                    return true;
	                }
	    ...
	    // Se l'elemento non � stato trovato, ritorno false
	    return false;
    }
    ...
    private class Itr implements Iterator<T> {
        ...
        public boolean hasNext() {
        	...
        	// Restituisco true se il nodo corrente non � nullo
        ...
        public T next() {
        	...
        	// se non ci sono pi� elementi lancio un'eccezione
        	if(!hasNext())
