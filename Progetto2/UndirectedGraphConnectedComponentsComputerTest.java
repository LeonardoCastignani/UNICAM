...
class UndirectedGraphConnectedComponentsComputerTest {
    ...
    final void testComputeConnectedComponentsExceptionsAndTrivialCases() {
        ...
        assertThrows(NullPointerException.class, () -> c.computeConnectedComponents(null));
        ...
        result.add(comp2);
        assertTrue(c.computeConnectedComponents(g).equals(result));
        g.addEdge(new GraphEdge<String>(new GraphNode<String>("a"), new GraphNode<String>("b"), false));
        result.remove(comp2);
    ...
    final void testComputeConnectedComponents() {
        ...
        g.addEdge(new GraphEdge<String>(new GraphNode<String>("a"), new GraphNode<String>("b"), false));
        g.addEdge(new GraphEdge<String>(new GraphNode<String>("d"), new GraphNode<String>("b"), false));
        g.addEdge(new GraphEdge<String>(new GraphNode<String>("c"), new GraphNode<String>("b"), false));
        g.addEdge(new GraphEdge<String>(new GraphNode<String>("c"), new GraphNode<String>("d"), false));
        Set<Set<GraphNode<String>>> result = new HashSet<>();
        Set<GraphNode<String>> comp1 = new HashSet<>();
        comp1.add(new GraphNode<String>("a"));
        comp1.add(new GraphNode<String>("b"));
        ...
        g.addEdge(new GraphEdge<String>(new GraphNode<String>("f"), new GraphNode<String>("e"), false));
        Set<GraphNode<String>> comp2 = new HashSet<>();
        ...
        g.addEdge(new GraphEdge<String>(new GraphNode<String>("g"), new GraphNode<String>("c"), false));
        result.remove(comp3);
        comp1.add(new GraphNode<String>("g"));
        assertTrue(c.computeConnectedComponents(g).equals(result));

        g.addEdge(new GraphEdge<String>(new GraphNode<String>("g"), new GraphNode<String>("g"), false));
        g.addEdge(new GraphEdge<String>(new GraphNode<String>("g"), new GraphNode<String>("f"), false));
        result.remove(comp2);
        ...
        g1.addEdge(new GraphEdge<String>(new GraphNode<String>("a"), new GraphNode<String>("b"), false));
        comp1.clear();
    ...
    final void testDenseGraph() {
        ...
        assertTrue(c.computeConnectedComponents(g).equals(result), "Un grafo completamente connesso dovrebbe essere una singola componente.");
    }
}
